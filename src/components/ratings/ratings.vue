      ...
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <star :size="36" :sore="seller.serviceScore"></star>
            <span class="score">{{seller.serviceScor}}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <star :size="36" :sore="seller.foodScore"></star>
          ...
          <li class="rating-item" v-for="rating in ratings" v-show="needShow(rating.rateType, rating.text)">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <star :size="24" :sore="rating.score"></star>
